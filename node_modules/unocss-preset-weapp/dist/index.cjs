...
const utilities = require('./shared/unocss-preset-weapp.42d31136.cjs');
const theme = require('./theme.cjs');
const _default = require('./shared/unocss-preset-weapp.a04041a6.cjs');
const variants = require('./variants.cjs');
const colors = require('./colors.cjs');
require('@unocss/rule-utils');
require('./shared/unocss-preset-weapp.9954e238.cjs');
require('./utils.cjs');
