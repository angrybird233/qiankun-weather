import { g as globalKeywords, h, b as handler, m as makeGlobalStaticRules, p as positionMap, e as parseColor, i as isCSSMathFn, c as colorResolver, f as directionMap, d as hasParseableColor, j as cornerMap, k as isSize, l as insetMap, r as resolveBreakpoints, n as directionSize, a as colorableShadows, s as splitShorthand } from './unocss-preset-weapp.53546b59.mjs';
...
import { g as transforms, e as boxShadows, c as rings, a as filters } from './unocss-preset-weapp.e40446a5.mjs';
...
const bgColors = [
  [/^bg-(.+)$/, (params, body) => {
    ...
    if (bgGradientRE.test(d) || bgImageRE.test(d)) {
      const s = handler.bracket(d);
      if (s) {
        const url = s.startsWith("http") ? `url(${s})` : handler.cssvar(s);
